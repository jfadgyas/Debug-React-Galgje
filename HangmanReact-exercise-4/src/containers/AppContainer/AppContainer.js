...
class AppContainer extends React.Component {
  ...
  guessLetterHandler = event => {
    if (!this.state.guessedLetters.includes(this.state.currentChosenLetter)){ //missing condition, to check if the array already includes out current letter
    ...
    this.setState({ currentChosenLetter: "" }); // clear the input field, even if our letter already exists
